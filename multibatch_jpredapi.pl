...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
# multibatch_jpredapi.pl makes regulated batch submissions of jobs to JPred4 REST API.
# Copyright (C) 2015 Fabian EGLI (fabian DOT egli AT biol DOT ethz DOT ch)
# 
